export const data = {
  banner: [
    {
      to: "/home",
      img: "../../images/banner/Banner_2_x.jpg",
      title: "Rent objects nearby",
      description: "The time has gone of buying the item, when you need it the short duration",
    },
    {
      to: "/home",
      img: "../../images/banner/Banner_3_x.jpg",
      title: "We use GPS to track",
      description: "The item you lend is safe, we track your item",
    },
    {
      to: "/home",
      img: "../../images/banner/Banner_1_x.jpg",
      title: "Offer variety of things",
      description: "We offer variety of items - electronics, daily use products",
    },
  ],
  iconProducts: [
    {
  ...
  books: [
    {
      ...
      link: "/product/detail",
      name: "Great product name goes here",
      img: "../../images/products/download.jfif",
      price: 180,
      originPrice: 200,
      discountPrice: 20,
      discountPercentage: 10,
    ...
    },
    {
      ...
      link: "/product/detail",
      name: "Great product name goes here",
      img: "../../images/products/download(2).jfif",
      price: 475,
      originPrice: 0,
      discountPrice: 0,
      discountPercentage: 0,
    ...
    },
    {
      ...
      link: "/product/detail",
      name: "Great product name goes here",
      img: "../../images/products/download(1).jfif",
      price: 10,
      originPrice: 0,
      discountPrice: 0,
      discountPercentage: 0,
