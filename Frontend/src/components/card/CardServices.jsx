    ...
    <div className="card">
      ...
      <div className="card-body">
        <div className="row border-bottom">
          ...
          <div className="col">
            <div className="ml-3">
              <span className="font-weight-bold">Location Tracking</span>
              <p className="text-muted small">Google Maps</p>
            </div>
          </div>
        </div>
        ...
        <div className="row pt-3">
          ...
          <div className="col">
            <div className="ml-3">
              <span className="font-weight-bold">Quality Check</span>
              <p className="text-muted small m-0">AI</p>
            </div>
          </div>
        </div>
      </div>
